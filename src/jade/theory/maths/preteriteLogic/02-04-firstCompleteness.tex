...
That is, either the theory will contain \(\theta \), \(¬\theta \), or \(\theta \) will be satisfiable in some but not all interpretations, and neither will be in the in theory.
...
Conversely if \(¬\theta \) is not in the theory, then \(\theta \) must be true under some interpretation.
