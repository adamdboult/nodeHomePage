...
\begin{itemize}
\item Excluding \(s\): \(v_{t_1}=a(t_1-t_0)+v_{t_0}\)
\item Excluding \(a\): \((s_{t_1}-s_{t_0})=v_{t_0}(t_1-t_0)+\dfrac{1}{2}a(t_1-t_0)^2\)
\item Excluding \(u_{t_0}\): \((s_{t_1}-s_{t_0})=v_{t_1}(t_1-t_0)-\dfrac{1}{2}a(t_1-t_0)^2\)
\item Excluding \(t\): \(v_{t_1}^2= v_{t_0}^2+2a(s_{t_1}-s_{t_0})\)
\item Excluding \(a\): \((s_{t_1}-s_{t_0})=(t_1-t_0)\dfrac{v_{t_1}+v_{t_1}}{2}\)
\end{itemize}
